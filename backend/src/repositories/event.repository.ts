...
export class EventRepository {
  ...
  async bulkCreateEvents(events: TrackedEvent[]): Promise<void> {
  ...
  /** Aggregate page views by session ID and order them by timestamp */
  async aggregateSessionEvents(matchStage: Record<string, unknown>): Promise<Array<{ _id: string; events: string[] }>> {
  ...
  async insertMany(events: unknown[]): Promise<void> {
